import { DEFAULT_CONFIG } from "./config.js?v=3.22.0";
import {
  cacheKey,
  configFromUrl,
  isNightTime,
  weatherInfo,
} from "./weather.js?v=3.22.0";
import { fetchWeather, getProvider } from "./providers.js?v=3.22.0";
import { initialiseSettings, loadSettings } from "./settings.js?v=3.22.0";
import {
  compareVersions,
  getLatestRelease,
  RELEASES_URL,
  VERSION_CACHE_KEY,
} from "./version.js?v=3.22.0";
import {
  getYearProgress,
  getYearProgressPresentation,
} from "./progress.js?v=3.22.0";
import {
  detectDisplay,
  formatDisplaySummary,
  resolveDisplay,
} from "./display.js?v=3.22.0";
import { applyStaticTranslations, translate } from "./i18n.js?v=3.22.0";
